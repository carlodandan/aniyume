import { fetchEpisodes, fetchServersForEpisode, fetchStreamData, PROXY_URL, fetchAnimeDetails } from './api.js';
...
export async function initPlayer() {
    ...
    try {
        // Fetch episode list and anime details concurrently
        const [episodeData, animeDetailsResponse] = await Promise.all([
